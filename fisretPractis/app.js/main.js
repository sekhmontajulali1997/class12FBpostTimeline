const post_form= document.querySelector('.postform');
...
const showPost = () =>{
    ...
    if (posts.length > 0) {
        ...
        postContent= '<h1> no post found</h1>';
    }
...
post_form.onsubmit = (e) =>{
    ...
    const getpost_formdata = new FormData(e.target);
    const objectpost_formdata = Object.fromEntries (getpost_formdata);
...
if (!objectpost_formdata.AthourName || !objectpost_formdata.AthourImage) {
    alert('filds are requied')
}else{


    const gatadaatformls = getdata('post');
    gatadaatformls.push(
        {
            AthourName: objectpost_formdata.AthourName,
            AthourImage: objectpost_formdata.AthourImage,
            post_content: objectpost_formdata.post_content ?? null,
            PostImage: objectpost_formdata.PostImage ?? null,
            post_time: Date.now(),
        }
